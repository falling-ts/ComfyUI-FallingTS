...
本项目是 ComfyUI 的插件扩展项目,毗邻 ComfyUI 核心项目运行。
...
- API 定义: `ComfyUI/openapi.yaml`
- 节点示例: `ComfyUI/comfy_extras/nodes_*.py`
- Partner 节点: `ComfyUI/comfy_api_nodes/nodes_*.py`
- 前端包: `comfyui-frontend-package==1.47.10`
- 开发指南: `ComfyUI/AGENTS.md`
